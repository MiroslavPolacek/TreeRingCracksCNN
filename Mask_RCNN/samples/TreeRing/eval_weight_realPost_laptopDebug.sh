...
FILES=(TreeRingComb2_onlyRing_50 TreeRingComb2_onlyRing_95 TreeRingComb2_onlyRing_98 TreeRingComb2_onlyRing_99 TreeRingComb2_onlyRing_100)

for FILE in ${FILES[@]}
do
  time python3 \
    /home/miroslavp/Github/TreeRingCracksCNN/Mask_RCNN/samples/TreeRing/evaluate_weights_conf_realPost.py \
    --TreeRingConf=$FILE \
