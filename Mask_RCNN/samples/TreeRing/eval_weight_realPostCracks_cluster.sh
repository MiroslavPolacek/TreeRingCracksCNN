...
time ~/.conda/envs/TreeRingCNN/bin/python3 \
  /users/miroslav.polacek/TreeRingCracksCNN/Mask_RCNN/samples/TreeRing/evaluate_weights_realPostCracks_simple.py \
  --TreeRingConf=TreeRingComb2_onlyCracks_0 \
  ...
  --path_out=/users/miroslav.polacek/eval_testing/results_Cracks
